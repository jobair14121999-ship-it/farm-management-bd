...
export interface Query<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> {
...
export declare class CollectionReference<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> extends QueryClass<AppModelType, DbModelType> {
