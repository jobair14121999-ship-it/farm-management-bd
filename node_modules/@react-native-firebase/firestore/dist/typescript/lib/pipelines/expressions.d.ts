...
export declare function createPipelineSubqueryExpression(kind: 'scalar' | 'array', pipeline: unknown): FunctionExpression;
/**
 * @beta
 ...
 */
export declare function constant(_value: number, _options?: {
 ...
 */
export declare function parent(_documentPath: string | DocumentReference): FunctionExpression;
/**
 * @beta
 * Returns the parent document reference from a path expression.
 */
export declare function parent(_documentPathExpr: Expression): FunctionExpression;
/**
 * @beta
 * Full-text search predicate for use within a search stage.
 */
export declare function documentMatches(_rquery: string | Expression): BooleanExpression;
/**
 * @beta
 ...
 */
export declare function geoDistance(_fieldName: string | Field, _location: GeoPoint | Expression): Expression;
/**
 * @beta
 ...
 */
export declare function switchOn(_condition: BooleanExpression, _result: Expression, ..._others: Array<BooleanExpression | Expression>): FunctionExpression;
/**
 * @beta
 ...
 */
export declare function ifNull(_ifExpr: Expression, _elseExpr: Expression): FunctionExpression;
export declare function ifNull(_ifExpr: Expression, _elseValue: unknown): FunctionExpression;
export declare function ifNull(_ifFieldName: string, _elseExpr: Expression): FunctionExpression;
export declare function ifNull(_ifFieldName: string, _elseValue: Expression | unknown): FunctionExpression;
export declare function ifNull(_ifFieldName: string | Expression, _elseValue: Expression | unknown): FunctionExpression;
/**
 * @beta
 * Returns the first non-null, non-absent argument without evaluating later arguments.
 */
export declare function coalesce(_expression: Expression, _replacement: Expression | unknown, ..._others: Array<Expression | unknown>): FunctionExpression;
export declare function coalesce(_fieldName: string, _replacement: Expression | unknown, ..._others: Array<Expression | unknown>): FunctionExpression;
/**
 * @beta
...
export declare function isType(_fieldName: string, _type: string): BooleanExpression;
export declare function isType(_expression: Expression, _type: string): BooleanExpression;
 ...
 */
export declare function timestampDiff(_endFieldName: string, _startFieldName: string, _unit: TimeUnit | Expression): FunctionExpression;
export declare function timestampDiff(_endFieldName: string, _startExpression: Expression, _unit: TimeUnit | Expression): FunctionExpression;
export declare function timestampDiff(_endExpression: Expression, _startFieldName: string, _unit: TimeUnit | Expression): FunctionExpression;
export declare function timestampDiff(_endExpression: Expression, _startExpression: Expression, _unit: TimeUnit | Expression): FunctionExpression;
/**
 * @beta
 * Extracts a calendar part from a timestamp (year, month, day, and so on).
 */
export declare function timestampExtract(_fieldName: string, _part: TimePart, _timezone?: string | Expression): FunctionExpression;
export declare function timestampExtract(_fieldName: string, _part: Expression, _timezone?: string | Expression): FunctionExpression;
export declare function timestampExtract(_timestampExpression: Expression, _part: TimePart, _timezone?: string | Expression): FunctionExpression;
export declare function timestampExtract(_timestampExpression: Expression, _part: Expression, _timezone?: string | Expression): FunctionExpression;
