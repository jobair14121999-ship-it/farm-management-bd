...
export const PIPELINE_SOURCE_TYPES = ['collection', 'collectionGroup', 'database', 'documents', 'query', 'subcollection'];
export const PIPELINE_STAGE_TYPES = ['where', 'select', 'addFields', 'removeFields', 'sort', 'limit', 'offset', 'aggregate', 'distinct', 'findNearest', 'search', 'define', 'replaceWith', 'sample', 'union', 'unnest', 'rawStage'];
