...
import { isArray, isNumber, isObject, isString, isUndefined } from '@react-native-firebase/app/dist/module/common';
import FirestorePath from "../FirestorePath.js";
import { Timestamp as FirestoreTimestamp } from "../FirestoreTimestamp.js";
...
import { createPipelineSubqueryExpression, documentMatches } from "./expressions.js";
...
class RuntimePipelineImpl {
  ...
  define(firstOrOptions, ...additionalExpressions) {
    if (isRecord(firstOrOptions) && hasAnyKey(firstOrOptions, ['variables']) && !hasAnyKey(firstOrOptions, ['__kind', 'exprType', 'expr', 'alias'])) {
...
export function createDetachedPipeline(source) {
