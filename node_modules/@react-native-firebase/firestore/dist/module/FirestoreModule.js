...
import { isAndroid, isBoolean, isFunction, isNumber, isObject, isString, isUndefined, isOther } from '@react-native-firebase/app/dist/module/common';
import { FirebaseModule } from '@react-native-firebase/app/dist/module/internal';
import { setReactNativeModule } from '@react-native-firebase/app/dist/module/internal/nativeModule';
import CollectionReferenceClass from "./FirestoreCollectionReference.js";
import DocumentReferenceClass from "./FirestoreDocumentReference.js";
import FirestorePath from "./FirestorePath.js";
import FirestorePersistentCacheIndexManagerClass from "./FirestorePersistentCacheIndexManager.js";
import QueryClass from "./FirestoreQuery.js";
...
export const nativeModuleNames = ['NativeRNFBTurboFirestore', 'NativeRNFBTurboFirestoreCollection', 'NativeRNFBTurboFirestoreDocument', 'NativeRNFBTurboFirestoreTransaction'];
...
export class FirebaseFirestoreModule extends FirebaseModule {
  type = 'firestore';
  ...
  namedQuery(queryName) {
    ...
    return new QueryClass(this, this._referencePath, new QueryModifiers(), queryName);
  }
  ...
  collection(collectionPath) {
    ...
    return new CollectionReferenceClass(this, path);
  }
  collectionGroup(collectionId) {
    ...
    return new QueryClass(this, this._referencePath.child(collectionId), new QueryModifiers().asCollectionGroupQuery(), undefined);
  }
  ...
  doc(documentPath) {
    ...
    return new DocumentReferenceClass(this, path);
  }
  async enableNetwork() {
    await this.native.enableNetwork();
  }
  runTransaction(updateFunction, options) {
  ...
  persistentCacheIndexManager() {
    ...
    return new FirestorePersistentCacheIndexManagerClass(this);
  }
}
...
//# sourceMappingURL=FirestoreModule.js.map