...
import { isBoolean, isFunction, isObject, isUndefined } from '@react-native-firebase/app/dist/module/common';
...
export default class QuerySnapshot {
  constructor(firestore, query, nativeData, converter) {
    ...
    this._docs = nativeData.documents.map(doc => new DocumentSnapshot(firestore, doc, converter));
