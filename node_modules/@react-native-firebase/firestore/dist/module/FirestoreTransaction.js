...
export default class Transaction {
  ...
  get(documentRef) {
    ...
    return this._firestore.native.transactionGetDocument(this._meta.id, documentRef.path).then(data => new DocumentSnapshot(this._firestore, data, documentRef.converter));
  }
