...
let memoizedMainModule = null;

/** Memoized main Firestore turbo host for static helpers (NewArch-AD-18 E8). */
export function getStaticFirestoreMainModule() {
  if (memoizedMainModule) {
    return memoizedMainModule;
  }
  const native = getReactNativeModule(FIRESTORE_MAIN_NATIVE_MODULE);
...
//# sourceMappingURL=staticNativeModule.js.map