...
import { hasOwnProperty, isArray, isBoolean, isFunction, isOther, isObject, isString, isUndefined } from '@react-native-firebase/app/dist/module/common';
import NativeFirebaseError from '@react-native-firebase/app/dist/module/internal/NativeFirebaseError';
import { fromDotSeparatedString, FieldPath } from "../FieldPath.js";
...
export function throwIfLiteSdkSnapshotListenerUnsupported() {
  if (!isOther) {
    return;
  }
