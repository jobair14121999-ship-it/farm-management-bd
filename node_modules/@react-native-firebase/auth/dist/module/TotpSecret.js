...
import { rethrowAuthSyncNativeError } from "./internal/syncNativeError.js";
export class TotpSecret {
  ...
  generateQrCodeUrl(accountName, issuer) {
    ...
    try {
      return this.auth.native.generateQrCodeUrl(this.secretKey, resolvedAccountName, resolvedIssuer);
    } catch (error) {
